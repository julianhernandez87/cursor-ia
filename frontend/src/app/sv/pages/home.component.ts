...
@Component({
  ...
  styles: [`
    ...
    .acciones-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--space-4); align-items: stretch; }
    ...
    .accion-card {
      ...
      text-align: center; cursor: pointer; transition: box-shadow var(--transition); min-height: 100px; padding: var(--space-4);
    }
    .accion-card:hover { box-shadow: var(--shadow-md); }
    .accion-icon { font-size: 1.75rem; color: var(--color-primary); flex-shrink: 0; }
    .accion-label { font-size: 0.85rem; color: var(--color-text); line-height: 1.3; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
    ...
    .promo-banner { display: grid; grid-template-columns: 1fr 1fr; min-height: 160px; padding: 0; overflow: hidden; }
    ...
    .promo-cta { align-self: flex-start; padding: var(--space-2) var(--space-4); background: var(--color-primary); color: #fff; border: none; border-radius: var(--radius-sm); font-weight: 600; cursor: pointer; font-size: 0.9rem; }
    ...
    @media (max-width: 640px) { .promo-banner { grid-template-columns: 1fr; } .promo-banner-visual { min-height: 100px; } }
  `],
})
